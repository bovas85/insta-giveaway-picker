...
describe('Analyzer Module', () => {
  ...
  it('should fail gracefully without configuration', async () => {
    // We expect it to fail or log error if we pass empty config but it might try to launch puppeteer
    // So checking type is enough for a smoke test without mocking the whole world
